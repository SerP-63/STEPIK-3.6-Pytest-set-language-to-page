...
def browser(request):
    ...
    # проверка языковых параметров, тест валится при несовпадении
    assert browser.find_element_by_xpath("/html").get_attribute("lang") == user_language, "!!! language No support !!!"
    browser.quit()
